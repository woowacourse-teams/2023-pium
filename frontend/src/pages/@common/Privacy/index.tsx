...
import { Header, Main, SubTitle, Title } from './Privacy.style';
    ...
    <PageLogger>
      ...
      <Main>
        <div>
          ...
          <br />
          <br />
          “개인정보처리방침”이란 이용자의 소중한 개인정보를 보호함으로써 이용자가 안심하고 서비스를
          ...
          <br />
          <br />
          이용자는 개인정보의 수집, 이용, 제공, 위탁 등과 관련한 아래 사항에 대하여 원하지 않는 경우
          동의를 거부할 수 있습니다. 다만, 이용자가 동의를 거부하는 경우 서비스의 전부 또는 일부를
          이용할 수 없음을 알려드립니다.
        </div>
        <div>
          ...
          디바이스 아이디의 경우, 서버와 통신시 악의적 사용을 막고 사용자를 구별하기 위해 암호화하여
          처리하고 있습니다.
          <strong>[구글 Firebase Analytics 를 이용한 앱로그 분석]</strong>
          회사는 구글에서 제공하는 앱 사용 분석 도구인 Firebase Analytics를 이용하고 있으며, 이 경우
          앱 사용 정보 외 개인을 식별할 수 있는 정보는 수집되지 않습니다. 이용자는 서비스 내에
          해제기능을 통하여 구글 Firebase Analytics 이용을 거부할 수 있습니다.
          <strong>[구글 Firebase Cloud Messaging을 통한 알림 서비스 구현 ]</strong>
          서비스는 구글에서 제공하는 푸시 서비스인 Firebase Cloud Messaging를 이용하고 있으며, 이를
          통해 사용자에게 알림을 제공하고 있습니다. 마이페이지에서 알림 거부 혹은 앱 자체에서 알림
          거부를 통해서 이용을 거부할 수 있습니다.
        </div>
        <div>
          ...
          <ul>
            ...
            <li>
              서비스 이용 기록, 접속 빈도 및 서비스 이용에 대한 통계, 프라이버시 보호 측면의 서비스
              환경 구축, 서비스 개선에 활용
            </li>
            <li>
              수집된 정보는 사용자에게 정보나 알림을 전달하거나 사용자 경험을 개선하기 위한 목적으로
              사용됩니다.
            </li>
            <li>
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              ...
              사고(계정분실, 장기미사용자 데이터 삭제 등)를 예방해 주시기 바랍니다. 이용자가 입력한
              부정확한 정보로 인해 발생하는 사고의 책임은 이용자 자신에게 있으며 타인 정보의 도용 등
              허위정보를 입력할 경우 서비스 회원 자격이 정지될 수 있습니다. 이용자 개인정보와 관련한
              아이디의 비밀번호에 대한 보안유지책임은 해당 이용자 자신에게 있습니다. 비밀번호는
              암화화되어 저장되기 때문에 서비스 운영자도 알 수 없습니다.
            </li>
          </ul>
        </div>
        <div>
